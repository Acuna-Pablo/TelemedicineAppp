    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        continueAndNextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(continueAndNextBtn.getText().equals("Submit") || checker.equals("Code Sent"))
                {
                    ...
                    {
                        Toast.makeText(RegistrationActivity.this, "Please write verfication code", Toast.LENGTH_SHORT).show();
                    }
                    else
                    {
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onCodeSent(@NonNull String s, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                ...
                loadingBar.dismiss();
                Toast.makeText(RegistrationActivity.this, "Text has been sent", Toast.LENGTH_SHORT).show();
        ...
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        {
                            loadingBar.dismiss();
                            Toast.makeText(RegistrationActivity.this, "Congratulations you are in!", Toast.LENGTH_SHORT).show();
